...
const SECTIONS: SectionDef[] = [
  { titleKey: 's0Title', bodyKeys: ['s0p0', 's0p1', 's0p2'] },
  { titleKey: 's1Title', bodyKeys: ['s1p0', 's1p1', 's1p2'] },
  { titleKey: 's2Title', bodyKeys: ['s2p0', 's2p1'] },
  { titleKey: 's3Title', bodyKeys: ['s3p0', 's3p1'] },
  { titleKey: 's4Title', bodyKeys: ['s4p0', 's4p1', 's4p2'] },
