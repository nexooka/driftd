    ...
    <footer className="relative bg-[#050505] border-t border-white/[0.06]">
      <div className="max-w-7xl mx-auto px-6 md:px-10 pt-16 md:pt-20 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 mb-14">
          ...
          {/* Brand */}
          <div>
            <a href="/" className="font-display text-2xl font-black italic tracking-tight leading-none block mb-3" style={{ letterSpacing: '-0.01em' }}>
        ...
        <div className="border-t border-white/[0.06] pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-warm-gray-400">© {new Date().getFullYear()} <span className="font-display font-black italic" style={{ letterSpacing: '-0.01em' }}><span className="text-warm-gray-300">drift</span><span className="text-amber-400/70">d</span></span></p>
